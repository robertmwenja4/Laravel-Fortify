...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input name="date" type="date" class="form-control @error('date') is-invalid @enderror" id="date" aria-describedby="date" value="{{ old('date') }} @isset($flight) {{ $flight->date }} @endisset">
    @error('date')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
